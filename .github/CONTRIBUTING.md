...
For further information/help, please consult the [nf-core/deepvariant documentation](https://nf-co.re/nf-core/deepvariant/docs) and don't hesitate to get in touch on the nf-core Slack [#deepvariant](https://nfcore.slack.com/channels/deepvariant) channel ([join our Slack here](https://nf-co.re/join/slack)).
