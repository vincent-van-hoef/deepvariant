...
```bash
nextflow run nf-core/deepvariant -profile <docker/singularity/conda/institute> --reads '*_R{1,2}.fastq.gz' --genome GRCh37
```
...
nf-core/deepvariant was originally written by Phil Palmer.
